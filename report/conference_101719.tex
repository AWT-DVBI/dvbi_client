...
We used the ScheduleInfoEndpoint descirebed in \cite{} and shown in figure \ref{fig:scheduleInfoEndpoint} to retrieve scheduleinfo meta data for specific programs .
...
Firstly, our implementation needed to be capable of handling the required REST APIs and XML Parsing from the DVB-I concept, including communication with the servicelist, mdp, and content guide servers. To achieve this, we developed a DVB-I Android Client Library as described in \ref{dvbi_parser}. 
